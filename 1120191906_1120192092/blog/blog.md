...
​       在结对过程中，基本上使用一人为观察员，一人为领航员的编程策略，保证主要代码由一个人进行开展，在层次训话地向前推进项目进度。

​	结对编程的优点还是比较显著的，结对编程减少了项目进行过程中的学习负担，两人不同的技术栈在不同的层面能够为项目的进行提供不一样的解决办法。虽然在一个点两个人的想法都不太一样，有可能有一些并不是很难的问题却能刚好卡住你自己，但是另一个人却能够顺利解决，致使我们在编写代码时，不容易出现一直无法实现某个功能或方法的情况。

​	关于结对编程，促进参与项目的程序员自身的提高，一对程序员工作的时候，水平较低的一方会潜移默化地受水平略高的程序员影响，学到一些新的东西，而水平高的一方同样因为不断地把自己的想法说出来而整理了自己的思路。我在此次项目中就学习到了较多有关python工程化的构建方法、git使用技巧等。

​	结对编程能够达到1+1>2的效果，在极端过程下使用较好，在时间有限的情况下能够互相激励、监督程序员对项目的推进。

## 12. 收获体会

- 了解了python编码规范和相应的代码评分工具
- 了解pytest coverage等测试评估工具
- 了解git使用方法，了解上游仓库复制到本地仓库等团队开发工具
- 对北京地铁路线有了深刻的印象和了解
- 了解了结对编程在极限开发中的功效
